(function() {
        ...
        farmers_veggies.fetch( function () {
                ...
                while ( farmers_veggies.hasNextEntity() ) {
                   //console.log('hecka');
                    ...
                    getRecipes(record_code + " this is getRecipes");
    ...
    function getRecipes (produce_code) {
       ...
       /* farmers_recipes.qs = { 'limit': 20,
           // 'ql': 'select * where ingredients.produceCode'+ '"' + produce_code + '"'
            'ql': 'select * where ingredients.'+produce_code+'="1"'
        ...
        farmers_recipes.fetch(//network call
            //success callback 
            function() {
                console.log('produce code '+produce_code); // works
               // console.log('length '+farmers_recipes.length);
